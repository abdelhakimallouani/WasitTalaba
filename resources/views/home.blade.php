    ...
    <main class="bg-slate-50">
        ...
        <section class="max-w-7xl mx-auto px-4 -mt-16 relative z-20">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div
                    class="bg-white p-6 rounded-2xl shadow-xl border border-slate-100 flex flex-col items-center cursor-pointer">
                    <div
                ...
                <div
                    class="bg-white p-6 rounded-2xl shadow-xl border border-slate-100 flex flex-col items-center cursor-pointer">
                    <div
                        class="w-12 h-12 bg-orange-50 text-orange-600 rounded-full flex items-center justify-center mb-3">
                        <i class="fas fa-book"></i>
                    </div>
                    <span class="font-bold text-slate-700">Cours</span>
                </div>
            </div>
        </section>
        ...
        <section class="max-w-7xl mx-auto px-4 py-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @forelse ($logements as $logement)
                    <div
                        class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all border border-slate-100 group">
                        <div class="relative h-64 overflow-hidden">
                            ...
                            <form action="{{ route('favoris.store', $logement) }}" method="POST"
                                ...
                                <button type="submit"
                                    ...
                                    <i class="{{ $logement->is_favorite ? 'fas' : 'far' }} fa-heart text-sm"></i>
                                </button>
                            </form>
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-2">
                                    <div class="w-6 h-6 bg-indigo-100 rounded-full flex items-center justify-center">
                                        <i class="fas fa-user text-[10px] text-indigo-600"></i>
                                    </div>
                                    <p>For <span
                                            class="text-xs font-medium text-slate-600">{{ $logement->user->name }}</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-slate-50">
                                ...
                                <a href="{{ route('logements.show', $logement) }}"
                                    class="w-10 h-10 border border-slate-100 rounded-full flex items-center justify-center text-indigo-600 hover:bg-indigo-600 hover:text-white transition-all">
