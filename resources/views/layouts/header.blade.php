<header class="relative min-h-[650px] w-full flex flex-col items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 text-center px-4 pt-16">
        <span
            class="inline-block bg-white/10 backdrop-blur-md text-white text-[10px] font-bold px-4 py-1.5 uppercase tracking-[0.2em] mb-6 border border-white/20">
        ...
        <div class="bg-white flex flex-col md:flex-row gap-2 w-full max-w-4xl mx-auto border border-white/20 mb-8">
            ...
            <div class="flex-1 flex items-center px-6 py-3 border-b md:border-b-0 md:border-r border-gray-100">
                ...
                <div class="text-left w-full">
                    <p class="block text-[10px] uppercase font-bold text-gray-400">LOCATION</p>
                    <p
                        class="w-full outline-none text-gray-700 bg-transparent appearance-none cursor-pointer">
                        All Locations
                    </p>
                </div>
            </div>
            ...
            <div class="flex-1 flex justify-center items-center px-6 py-3 border-b md:border-b-0 md:border-r border-gray-100">
                <i class="fas fa-filter text-indigo-500 mr-4 text-lg"></i>
                <div class="text-left w-full">
                    <p class="block text-[10px] uppercase font-bold text-gray-400">MAX PRIX</p>
                    <p
                        class="w-full outline-none text-gray-700 bg-transparent appearance-none cursor-pointer">
                        No Limit
                    </p>
